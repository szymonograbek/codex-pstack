...
1. Spawn the `comment-sicko` custom agent (`gpt-5.6-sol/medium`) and tell it to read `../poteto-mode/references/agents/comment-sicko.md`. Pass the scope. Do not restate its rules.
