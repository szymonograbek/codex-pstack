...
> Build a Codex task prompt from this template after checking that the execution checkout contains the pack and configuration. Follow `../references/scheduling.md` for event delivery or polling.
